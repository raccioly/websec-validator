...
shared `RepoContext`, then runs 21 extractors over it; the downstream modules turn those facts into
...
```mermaid
graph LR
    R[your repo] --> A[1. Recon<br/>21 extractors]

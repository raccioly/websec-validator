...
## [Unreleased]
- **Extractors**: `SurfaceExtractor` fixed to catch SQL injection cases where a vulnerable formatted SQL string is assigned to a variable just before execution (e.g. VAmPI pattern).

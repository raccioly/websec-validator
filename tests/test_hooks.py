...
class HooksTests(unittest.TestCase):
    ...
    def test_end_to_end_post_commit_runs(self):
        ...
        # Manually ensure core.hooksPath is set to .git/hooks to avoid global config interference
        subprocess.run(["git", "config", "core.hooksPath", ".git/hooks"], cwd=self.root, check=True, env=env)

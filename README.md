...
required CI checks pass. The resulting main commit subject must be `release: v0.15.2` for this
...
Version 0.15.2 provides 22 recon extractors, eleven optional scanner entries, nine named profiles,
...
changes. 0.15.2 is a patch over 0.15.1 and needs no migration.

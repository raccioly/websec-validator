...
If `websec` isn't installed: `pipx install <path-to-this-repo>` first. If it's missing scanners,
the briefing lists install hints — offer to install them, don't block on them.
